<template>
  <div class="app-container">
    ...
    <el-form v-if="this.order.payStatus === 20 && this.order.deliveryStatus === 10" ref="dataForm" :rules="rules" :model="expressTemp" label-position="left" label-width="120px" style="width: 1100px; margin-left:50px;">
     ...
     <el-form v-else-if="this.order.payStatus === 20 && this.order.deliveryStatus === 20" ref="dataForm" label-position="left" label-width="120px" style="width: 1100px; margin-left:50px;">
      <el-form-item label="物流公司名称">
        <el-input readonly v-model="this.order.expressCompany" />
      </el-form-item>
      <el-form-item label="物流单号">
        <el-input readonly v-model="this.order.expressNo" />
      </el-form-item>
    </el-form>
    </div>
  </div>
